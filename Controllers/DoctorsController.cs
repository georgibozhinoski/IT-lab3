...
namespace lab3._1.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            return db.Hospitals.Find(id).Name;
        }
        public String GetHospitalAddress(int id)
        {
            return db.Hospitals.Find(id)?.Address;
        }
        ...
        [HttpPost]
        public ActionResult AddPatientDoctor(PatientDoctor model)
        {
